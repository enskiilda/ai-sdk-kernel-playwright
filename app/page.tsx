...
// Kernel browser URL fetching moved to API route
...
export default function Chat() {
  ...
  const refreshDesktop = async () => {
    try {
      ...
      const response = await fetch('/api/get-browser', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ sandboxId: sandboxId || undefined }),
      });
            ...
            {streamUrl ? (
              <>
                <iframe
                  ...
                  allow="autoplay; camera; microphone; display-capture; clipboard-read; clipboard-write"
